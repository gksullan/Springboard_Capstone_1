...
def train_eval(filename, hyper_dict, hyperparam_table):
    """
    ...
    hyper_dict['data_size'] = str(df.shape)
    if hyper_dict['scaling']:
    ...
    train_test_write(x_train, x_test, y_train, y_test, filename=hyper_dict['filename'], scaled=hyper_dict['scaling'])
